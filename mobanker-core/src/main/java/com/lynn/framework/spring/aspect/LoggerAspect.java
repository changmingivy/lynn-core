package com.mobanker.framework.spring.aspect;
...
/**
 * Package Name: com.mobanker.framework.spring.aspect
 * Description:
 * Author: qiuyangjun
...
public class LoggerAspect {
     ...
     * 该方法就是一个标识，不进行调用
     */
    @Pointcut("execution(* com.mobanker..web*..*(..)) || execution(* com.mobanker..service*..*(..)) || execution(* com.mobanker..dao*..*(..))")
