package com.lynn.framework.spring.aspect;
...
/**
 * Package Name: com.lynn.framework.spring.aspect
 * Description:
 * Author: qiuyangjun
...
public class LoggerAspect {
     ...
     * 该方法就是一个标识，不进行调用
     */
    @Pointcut("execution(* com.lynn..web*..*(..)) || execution(* com.lynn..service*..*(..)) || execution(* com.lynn..dao*..*(..))")
