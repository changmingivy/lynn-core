package com.lynn.framework.convert;

import com.alibaba.fastjson.serializer.SerializeConfig;
import com.lynn.framework.fastjson.serializer.EnumSerializer;
import com.lynn.common.utils.ClassPathScanHandler;
...
/**
 * Package Name: com.lynn.framework.convert
 * Description:
 * Author: qiuyangjun
...
public class FastJsonHttpMessageConverter extends com.alibaba.fastjson.support.spring.FastJsonHttpMessageConverter {
    ...
    protected void writeInternal(Object obj, HttpOutputMessage outputMessage) throws IOException,
        ...
        Set<Class<?>> calssList = handler.getPackageAllClasses("com.lynn", true);
